...
def graph_data():
    data = pd.read_csv("final_delays.csv")
    ...
    # stop_name, delay_sec, sch_dur_sec, and act_dur_sec.
    ...
    data['delay_sec'] = ((data['delay_sec'] + 43200) % 86400) - 43200 #data['delay_sec'].apply(lambda x: -(-x % 86400) if x < -86400 else x % 86400 if x < -43200 else x)
